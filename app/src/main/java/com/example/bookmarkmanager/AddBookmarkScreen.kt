...
fun AddBookmarkScreen(
    ...
    // Local state for each text field
    ...
    Scaffold(
        ...
        Column(
            ...
            // Title input field with error support
            OutlinedTextField(
                value = title,
                onValueChange = {
                    title = it
            ...
            // URL input field with error support
            OutlinedTextField(
                value = url,
                onValueChange = {
                    url = it
            ...
            // Category input field (optional, no validation)
            OutlinedTextField(
                value = category,
            ...
            Button(onClick = {
                ...
                if(!titleError && !urlError){
                    onSave(
                        title.trim(),
                        url.trim(),
                        category.trim().ifEmpty { "Uncategorized" }
                    )
                }
            },
                modifier = Modifier.fillMaxWidth()
